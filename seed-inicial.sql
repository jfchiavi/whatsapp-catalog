...
-- ===============================
INSERT INTO "User"
(id, name, email, password, role, "branchId", "tenantId", "createdAt", "updatedAt")
VALUES
(
  'user-demo-admin',
  'Admin Demo',
...
-- ===============================
INSERT INTO "Product"
(id, name, "imageUrl", batch, "expirationDate", active, "baseAttributes", "createdAt", "updatedAt", "tenantId")
VALUES
  ('prod-demo-1', 'Remera Negra', 'https://example.com/remera-negra.jpg', 'LOTE-2026-001', NULL, true, '{"metrosPorCaja": 10}', NOW(), NOW(), 'tenant-demo'),
  ('prod-demo-2', 'Jean Azul', 'https://example.com/jean-azul.jpg', 'LOTE-2026-002', NULL, true, '{"metrosPorCaja": 5}', NOW(), NOW(), 'tenant-demo'),
  ('prod-fashion-1', 'Campera Cuero', 'https://example.com/campera-cuero.jpg', 'LOTE-2026-003', NULL, true, '{"metrosPorCaja": 2}', NOW(), NOW(), 'tenant-fashion');

-- ===============================
-- VARIANTES (una variante por producto por ahora)
-- ===============================
INSERT INTO "Variant"
(id, "productId", "tenantId", sku, price, cost, attributes, "createdAt", "updatedAt")
VALUES
  ('variant-demo-1', 'prod-demo-1', 'tenant-demo', 'SKU-D-001', 10000, 6000, '{"color": "negro", "talle": "unico"}', NOW(), NOW()),
  ('variant-demo-2', 'prod-demo-2', 'tenant-demo', 'SKU-D-002', 18000, 11000, '{"color": "azul", "talle": "M"}', NOW(), NOW()),
  ('variant-fashion-1', 'prod-fashion-1', 'tenant-fashion', 'SKU-F-001', 60000, 42000, '{"color": "negro", "talle": "L", "material": "cuero"}', NOW(), NOW());
