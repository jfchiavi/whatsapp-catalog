...
INSERT INTO "User" (id, name, email, password, role, "branchId", "tenantId") VALUES
  ('user-admin', 'Admin Demo', 'admin@demo.com', '$2b$10$4EugrtvDPexe0g4OSYo77exqwxrQU.mLgSWQSQVmo3j4j6SZvkpZC', 'SUPER_ADMIN', null, 'tenant-demo'),
  ('user-manager', 'Gerente Central', 'manager@demo.com', '$2b$10$4EugrtvDPexe0g4OSYo77exqwxrQU.mLgSWQSQVmo3j4j6SZvkpZC', 'BRANCH_MANAGER', 'branch-central', 'tenant-demo'),
  ('user-seller', 'Vendedor Tienda', 'seller@demo.com', '$2b$10$4EugrtvDPexe0g4OSYo77exqwxrQU.mLgSWQSQVmo3j4j6SZvkpZC', 'SELLER', 'branch-central', 'tenant-demo');

-- Productos
INSERT INTO "Product" (id, name, "imageUrl", batch, "expirationDate", "baseAttributes", active, "tenantId") VALUES
  ('prod-1', 'Remera Oversize', null, 'LOTE-2025-01', null, '{"color": "negro", "material": "algodon"}', true, 'tenant-demo'),
  ('prod-2', 'Pantalón Jean Slim', null, 'LOTE-2025-02', null, '{"color": "azul oscuro", "talle": "42"}', true, 'tenant-demo'),
  ('prod-3', 'Zapatillas Urban Run', null, 'LOTE-2025-03', null, '{"color": "blanco", "talle": "41"}', true, 'tenant-demo');

-- Variantes
INSERT INTO "Variant" (id, "productId", sku, price, cost, attributes, "tenantId") VALUES
  ('var-1', 'prod-1', 'REM-NEG-S', 8500, 5000, '{"talle": "S"}', 'tenant-demo'),
  ('var-2', 'prod-1', 'REM-NEG-M', 8500, 5000, '{"talle": "M"}', 'tenant-demo'),
  ('var-3', 'prod-1', 'REM-NEG-L', 9000, 5200, '{"talle": "L"}', 'tenant-demo'),
  ('var-4', 'prod-2', 'JEAN-SLIM-38', 18000, 11000, '{"talle": "38"}', 'tenant-demo'),
  ('var-5', 'prod-2', 'JEAN-SLIM-42', 18500, 11500, '{"talle": "42"}', 'tenant-demo'),
  ('var-6', 'prod-3', 'ZAP-URBAN-40', 35000, 25000, '{"talle": "40"}', 'tenant-demo'),
  ('var-7', 'prod-3', 'ZAP-URBAN-41', 35000, 25000, '{"talle": "41"}', 'tenant-demo'),
  ('var-8', 'prod-3', 'ZAP-URBAN-42', 36000, 26000, '{"talle": "42"}', 'tenant-demo');
