...
function TenantProductDetailContent() {
  const { id } = useParams();
  ...
  if (error) {
    return <p className="p-4 text-red-600">Error al cargar producto</p>;
  }
    ...
    <div className="min-h-screen" style={{ '--primary-color': tenant?.primaryColor } as React.CSSProperties}>
      ...
      <main className="max-w-7xl mx-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <Link to={`/t/${tenant?.slug}`} className="text-sm text-blue-600">
