-- Migration: Complete init matching current schema.prisma
-- Consolidates: init + whatsapp_orders tenantId + refresh_token tenantId + StockMovement branch FKs
